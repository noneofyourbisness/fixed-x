...
if isfile then
	if not isfile("CMD-X.lua") then
		Stand("Looks like you're new here!","To view commands, use .commands","You can use different stuff like .hotkeys","","","Okay",true)
...
output3.Text = "Fixed by ThreeDayMystery, say CMDs/help to view the list of commands"
...
local Hints = {"Did you know you can execute multiple commands with ';;'?","Did you know you can create a wait using timedcmd in loops?","You can find commands using 'cmds'.","You can change your prefix by doing 'prefixnew (key)'","Did you know that the world's longest concert lasted 453 hours?"}
